...
#include "mnpch.h" // Minerva PCH

#include <imgui.h> // Minerva
#include "Minerva/ImGui/imgui_impl_glfw.h" // Minerva
...
namespace Minerva
{
    bool g_ImGuiOverrideBlockKeyEvents = false;
    bool g_ImGuiOverrideBlockMouseButtonEvents = false;
    bool g_ImGuiOverrideBlockMouseScrollEvents = false;
    bool g_ImGuiOverrideBlockMouseButtonLeftRelease = false;
    bool g_ImGuiOverrideBlockMouseButtonRightRelease = false;
}
...
void ImGui_ImplGlfw_MouseButtonCallback(GLFWwindow* window, int button, int action, int mods)
{
    ...
    {
        bool forwardEvent = Minerva::g_ImGuiOverrideBlockMouseButtonEvents;
        if (action == GLFW_RELEASE)
        {
            if (Minerva::g_ImGuiOverrideBlockMouseButtonLeftRelease && button == GLFW_MOUSE_BUTTON_LEFT)
            {
                Minerva::g_ImGuiOverrideBlockMouseButtonLeftRelease = false;
                forwardEvent = true;
            }
            if (Minerva::g_ImGuiOverrideBlockMouseButtonRightRelease && button == GLFW_MOUSE_BUTTON_RIGHT)
            {
                Minerva::g_ImGuiOverrideBlockMouseButtonRightRelease = false;
                forwardEvent = true;
            }
        }

        if (forwardEvent || !ImGui::GetIO().WantCaptureMouse)
...
void ImGui_ImplGlfw_ScrollCallback(GLFWwindow* window, double xoffset, double yoffset)
{
    ...
    if (g_PrevUserCallbackScroll != NULL && window == g_Window &&
        (Minerva::g_ImGuiOverrideBlockMouseScrollEvents || !ImGui::GetIO().WantCaptureMouse))
...
void ImGui_ImplGlfw_KeyCallback(GLFWwindow* window, int key, int scancode, int action, int mods)
{
    ...
    if (g_PrevUserCallbackKey != NULL && window == g_Window &&
        (Minerva::g_ImGuiOverrideBlockKeyEvents || !ImGui::GetIO().WantCaptureKeyboard))
